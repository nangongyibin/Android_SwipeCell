...
public class FlowLayout extends ViewGroup {
    private List<Line> lines = new ArrayList<>();//用来记录描述有多少行view
    ...
    class Line {
        ...
        public void addView(View view) {
            ...
            //size == 0表示还没有添加view
            if (size == 0) {
                //如果添加view的宽度大于最大宽度，name已经使用的宽度就赋值给最大宽度
         ...
         * 给孩子布局
         *
         * @param paddingLeft 孩子左边位置的偏移量
         * @param paddingTop  孩子顶部位置的偏移量
         */
        public void layout(int paddingLeft, int paddingTop) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                int top = (int) (paddingTop + (this.height - height) / 2 + 0.5f);
